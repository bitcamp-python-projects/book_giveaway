# Generated by Django 5.0.1 on 2024-02-10 20:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('administrator', 'Administrator'), ('owner', 'Owner'), ('user', 'User')], max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition', models.ManyToManyField(to='books.condition')),
